...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-10 xl:px-4 w-full mx-auto mt-5 rounded-xl overflow-hidden">
      <div className="max-w-[1350px] mx-auto px-3 py-3 bg-white/40 dark:bg-black/30 backdrop-blur-sm rounded-xl overflow-hidden">
